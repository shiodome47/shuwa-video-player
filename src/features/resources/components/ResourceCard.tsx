 ...
 *
 * Phase 3 変更点:
 * - onEdit / onDelete を必須プロパティに変更（Phase 1 は optional だった）
 * - お気に入りトグルを recordAccess と共に接続
 * - 開いたときに lastAccessedAt を更新
 */
export function ResourceCard({ link, category, onEdit, onDelete }: ResourceCardProps) {
  ...
  return (
    <div className="group flex flex-col rounded-xl border border-neutral-800 bg-neutral-900 p-4 transition-colors hover:border-neutral-700">
      {/* ヘッダー: お気に入り + カテゴリ */}
